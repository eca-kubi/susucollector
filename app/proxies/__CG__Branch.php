 ...
 */
class Branch extends \Branch implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Branch' . "\0" . 'id', '' . "\0" . 'Branch' . "\0" . 'name', '' . "\0" . 'Branch' . "\0" . 'administrators', '' . "\0" . 'Branch' . "\0" . 'agents', '' . "\0" . 'Branch' . "\0" . 'accounts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Branch $proxy) {
    ...
    public function addToAdministrators(\Administrator $administrator): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addToAdministrators', [$administrator]);

        parent::addToAdministrators($administrator);
    }
    ...
    public function addToAgents(\Agent $agent): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addToAgents', [$agent]);

        parent::addToAgents($agent);
    }
    ...
    public function addToAccounts(\Account $account): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addToAccounts', [$account]);

        parent::addToAccounts($account);
    }
