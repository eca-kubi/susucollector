<div class="container font-weight-bold fixed-top bg-secondary">
    <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand" href="#"><img class="img-fluid" src="<?php
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                echo $dto->pageId->value == PageIdsDTO::HOME ? 'active' : ''; ?> nav-item"><a class="nav-link"
                ...
                <li class="<?php echo $dto->pageId->value == PageIdsDTO::EMPLOYEE_LOGIN ? 'active' : ''; ?> nav-item"><a class="nav-link"
                            href="<?php echo URL_ROOT ?>/employees/dashboard"><i class="fa fa-user-chart"></i> Agent</a></li>
            </ul>
        </div>
    </nav>
</div>
